...
const rp = require('request-promise-native/errors');
...
exports.rp = {
  RequestError: rp.RequestError,
  StatusCodeError: rp.StatusCodeError,
  TransformError: rp.TransformError
};
